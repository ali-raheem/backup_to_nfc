...
# From https://github.com/mdeverdelhan/YHY523U-driver
# Copyright (c) 2013 Marc de Verdelhan
...
if __name__ == '__main__':
    ...
    device.select()
    print to_hex(device.read_sector(4, '\xfF'*6, (2, 3)))
    device.write_block(4, '\xFF'*6, 2, '\xde\xad\xbe\xef'*4)
    print to_hex(device.read_sector(4, '\xff'*4, (2, 3)))
